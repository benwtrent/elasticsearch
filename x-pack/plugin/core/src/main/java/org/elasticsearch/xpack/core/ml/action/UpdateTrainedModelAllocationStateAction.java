...
public class UpdateTrainedModelAllocationStateAction extends ActionType<AcknowledgedResponse> {
    ...
    public static class Request extends MasterNodeRequest<Request> {
        ...
        private final TrainedModelAllocation.RoutingStateAndReason routingState;

        public Request(String nodeId, String modelId, TrainedModelAllocation.RoutingStateAndReason routingState) {
        ...
        public Request(StreamInput in) throws IOException {
            ...
            this.routingState = new TrainedModelAllocation.RoutingStateAndReason(in);
        }
        ...
        public TrainedModelAllocation.RoutingStateAndReason getRoutingState() {
            return routingState;
        }

...
public class TransportCreateTrainedModelAllocationAction extends TransportMasterNodeAction<Request, Response> {
    ...
    protected TransportCreateTrainedModelAllocationAction(
    ...
    protected void masterOperation(Task task, Request request, ClusterState state, ActionListener<Response> listener) throws Exception {
        trainedModelAllocationClusterService.createNewModelAllocation(request.getTaskParams(), ActionListener.wrap(
            trainedModelAllocation -> listener.onResponse(new Response(trainedModelAllocation)),
            listener::onFailure
        ));
    }

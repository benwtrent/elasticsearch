...
public class TrainedModelAllocationMetadata implements Metadata.Custom {
    ...
    public static TrainedModelAllocationMetadata metadata(ClusterState clusterState) {
        ...
        return trainedModelAllocationMetadata == null ?
            EMPTY :
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        return builder.map(modelRoutingEntries);
    }
    ...
    public static class Builder {
        ...
        private Builder(TrainedModelAllocationMetadata modelAllocationMetadata) {
            ...
            modelAllocationMetadata.modelRoutingEntries.forEach((modelId, allocation) ->
                modelRoutingEntries.put(modelId, TrainedModelAllocation.Builder.fromAllocation(allocation))
            );
        }
        ...
        Builder addNewAllocation(String modelId, String indexName) {
            if (modelRoutingEntries.containsKey(modelId)) {
                return this;
            }
            modelRoutingEntries.put(modelId, TrainedModelAllocation.Builder.empty(indexName));
            isChanged = true;
            return this;
        }

        Builder updateAllocation(String modelId, String nodeId, TrainedModelAllocation.RoutingStateAndReason state) {
        ...
        public TrainedModelAllocationMetadata build() {
            ...
            modelRoutingEntries.forEach((modelId, allocation) ->
                allocations.put(modelId, allocation.build())
            );

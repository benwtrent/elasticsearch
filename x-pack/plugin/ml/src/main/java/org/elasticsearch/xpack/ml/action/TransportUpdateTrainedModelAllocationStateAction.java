...
public class TransportUpdateTrainedModelAllocationStateAction  extends AcknowledgedTransportMasterNodeAction<Request> {

    private final TrainedModelAllocationClusterService trainedModelAllocationClusterService;
    protected TransportUpdateTrainedModelAllocationStateAction(
        ...
        super(
            UpdateTrainedModelAllocationStateAction.NAME,
            false,
            transportService,
            clusterService,
            threadPool,
    ...
    protected void masterOperation(Task task, Request request, ClusterState state, ActionListener<AcknowledgedResponse> listener)
        throws Exception {
        trainedModelAllocationClusterService.updateModelRoutingTable(request, listener);
    }

...
public class TransportDeleteTrainedModelAllocationAction extends AcknowledgedTransportMasterNodeAction<Request> {

    private final TrainedModelAllocationClusterService trainedModelAllocationClusterService;
    protected TransportDeleteTrainedModelAllocationAction(
    ...
    protected void masterOperation(Task task, Request request, ClusterState state, ActionListener<AcknowledgedResponse> listener)
        throws Exception {
        trainedModelAllocationClusterService.removeModelAllocation(request.getModelId(), listener);
    }

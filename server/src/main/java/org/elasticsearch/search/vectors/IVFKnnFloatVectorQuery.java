...
public class IVFKnnFloatVectorQuery extends AbstractIVFKnnVectorQuery {
     ...
     */
    public IVFKnnFloatVectorQuery(String field, float[] query, int k, int numCands, Query filter, float percent, int nProbe) {
        super(field, nProbe, percent, k, numCands, filter);
        this.query = query;
    }

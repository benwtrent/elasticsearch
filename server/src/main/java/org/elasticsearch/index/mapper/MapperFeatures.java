...
public class MapperFeatures implements FeatureSpecification {
    ...
    static final NodeFeature BBQ_DISK_FORMAT_CLUSTER_FEATURE = new NodeFeature("mapper.bbq_disk_format_cluster_feature");
    static final NodeFeature BBQ_DISK_NESTED_SUPPORT = new NodeFeature("mapper.bbq_disk_nested_support");
    ...
    public Set<NodeFeature> getTestFeatures() {
        return Set.of(
            ...
            BBQ_DISK_FORMAT_CLUSTER_FEATURE,
            BBQ_DISK_NESTED_SUPPORT,
